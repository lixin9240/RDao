...
class WJCController extends Controller
{
    ...
    private function getResourceType(): string
    {
        ...
        if (str_starts_with($name, 'customer-rd-investment.')) return 'customer-rd-investment';
        return '';
    }
    ...
    private function responseOk(mixed $data = null, string $message = ''): JsonResponse
    {
        return match ($this->getResourceType()) {
            ...
            'customer-business', 'customer-enterprise', 'customer-rd-investment' => response()->json(['success' => true, 'message' => $message, 'data' => $data]),
    ...
    private function responseFail(string $message = ''): JsonResponse
    {
        return match ($this->getResourceType()) {
            ...
            'customer-business', 'customer-enterprise', 'customer-rd-investment' => response()->json(['success' => false, 'message' => $message, 'data' => null]),
    ...
    public function index(Request $request): JsonResponse
    {
        return match ($this->getResourceType()) {
            ...
            'customer-rd-investment' => $this->responseOk($this->service->rdInvestmentList($request), '获取成功'),
    ...
    public function store(WJCRequest $request): JsonResponse
    {
        ...
        return match ($this->getResourceType()) {
            ...
            'customer-rd-investment' => $this->responseOk(['id' => $this->service->rdInvestmentStore($data)->id], '创建成功'),
            default           => $this->responseFail('未知资源类型'),
        };
    }
    ...
    public function show(Request $request, string|int|null $id = null): JsonResponse
    {
        ...
        return match ($this->getResourceType()) {
            ...
            'customer-rd-investment' => $this->handleFind($this->service->rdInvestmentFind($id), '获取成功'),
            default           => $this->responseFail('未知资源类型'),
        };
    }
    ...
    public function update(WJCRequest $request, string|int|null $id = null): JsonResponse
    {
        ...
        return match ($this->getResourceType()) {
            ...
            'customer-rd-investment' => $this->handleResult($this->service->rdInvestmentUpdate($id, $data), '更新成功'),
            default           => $this->responseFail('未知资源类型'),
        };
    }
    ...
    public function destroy(Request $request, string|int|null $id = null): JsonResponse
    {
        ...
        return match ($this->getResourceType()) {
            ...
            'customer-rd-investment' => $this->handleResult($this->service->rdInvestmentDelete($id), '删除成功'),
            default           => $this->responseFail('未知资源类型'),
        };
    }
}